            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  <span className="font-semibold text-orange-600">24 mois</span>{" "}
          ...
          <div className="border-l-4 border-red-500 pl-4">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  MLP Insight met en œuvre des mesures de sécurité pour protéger
                  vos données.{" "}
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3 leading-relaxed">
                  Conformément au Règlement (UE) 2016/679 (RGPD), vous disposez
                  d'un droit d'accès, de rectification, de suppression, de
                  portabilité de vos données, ainsi qu'un droit à la limitation
                  du traitement.
                </p>
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  l'expérience utilisateur. Vous pouvez refuser l'utilisation de
                  ces cookies via les paramètres de votre navigateur.
                </p>
              </div>
            </div>
          </div>
